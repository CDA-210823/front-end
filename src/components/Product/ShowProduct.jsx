...
const DetailsProduct = () => {
    ...
    return (
        <div className='flex max-md:mt-2 justify-around my-24 items-center max-sm:flex-col-reverse'>
            <div className='bg-detailsProduct rounded shadow-boxShadow lg:mt-5 lg:w-1/5 lg:mr-5 p-10 sm:mt-0 sm:mr-0 sm:w-full  md:mt-2 md:mr-2 sm:m-1'>
            ...
            <div className='bg-detailsProduct rounded shadow-boxShadow lg:mt-5 lg:w-1/2 lg:mr-5 p-10 sm:mr-0 all:p-1 m-1 md:m-1 my-2'>
